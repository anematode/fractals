//============================================================================
// Name        : customfractal.cpp
// Author      : anematode
// Version     : 1.0.0
// Copyright   : N/A
// Description : Generation of a custom fractal through iterative application of a function onto the complex numbers.
//============================================================================
...
string filename = "/Users/anematode/Desktop/customfractal.pgm";
	...
	for (double y = im_min; y < im_max; y += ydelta) {		// For all imaginary positions y...
		...
		for (double x = re_min; x < re_max; x += xdelta) {	// For all real positions x...
			...
			while (z.real()*z.real() + z.imag()*z.imag() < radiussquared
				...
				z = k*z*z*z*z-0.6*z*z*z+0.3*z*z+0.2*z-k;
